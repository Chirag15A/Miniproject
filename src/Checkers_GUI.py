...
button1 = Button(Frame1,text="Play",height= 5, width=20, bg = "red", command = root.destroy)
button1.place(x = 700, y = 400)
button1 = Button(Frame1,text="Instructions",height= 5, width=20, bg = "red", command = instruct)
